<?php 
$page_title = 'E Commerce Industry';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const pageSlug = 'e-commerce-industry'; // IMPORTANT: Set the slug for the current page
    ...
    function createPageContent(slug) {
        const pageData = {
            "slug": slug,
            "title": "E-commerce Industry Solutions | Web Nexa Technologies",
            "meta_description": "We provide end-to-end solutions for the e-commerce industry, from building high-performance online stores to executing data-driven marketing campaigns that drive sales.",
            "banner_image_url": "assets/images/header-icon/Industries/eCommerce (2).png",
            "banner_title": "E-commerce Industry",
            "breadcrumb_items": [
            ...
            "sections": [
                {
                    "section_order": 0,
                    "type": "hero",
                    "subtitle": "Thrive in the Digital Marketplace",
                    "title": "Integrated Solutions for Online Retail",
                    "content_json": {
                        "text": "<p>The e-commerce landscape is more competitive than ever. Success requires a powerful online store, a seamless customer experience, and a smart marketing strategy. We provide comprehensive solutions for online retailers, combining robust e-commerce development with performance marketing services to help you attract more customers, increase conversion rates, and build a loyal following.</p>"
                    }
                },
                {
                    "section_order": 1,
                    ...
                    "content_json": [
                        {"icon": "fa-solid fa-store", "title": "E-commerce Platform Development", "description": "Building custom online stores on platforms like Shopify, Magento, and WooCommerce, tailored to your business needs."},
                        {"icon": "fa-solid fa-mobile-screen-button", "title": "Mobile Commerce (M-commerce)", "description": "Ensuring your online store is fully optimized for mobile devices to provide a seamless shopping experience on the go."},
                        {"icon": "fa-solid fa-credit-card", "title": "Payment Gateway Integration", "description": "Integrating a wide range of secure payment options to make the checkout process smooth and trustworthy for your customers."},
                        {"icon": "fa-solid fa-magnifying-glass-dollar", "title": "E-commerce SEO", "description": "Optimizing your product pages, categories, and site structure to rank higher in search results and drive organic traffic."},
                        {"icon": "fa-brands fa-google", "title": "Google Shopping & PPC Management", "description": "Managing targeted ad campaigns on Google Search and Shopping to drive high-intent traffic and sales."},
                        {"icon": "fa-solid fa-envelope-open-text", "title": "Email & Abandoned Cart Marketing", "description": "Implementing automated email sequences to recover abandoned carts and nurture customers towards a purchase."}
                    ]
                }
            ]
        };
