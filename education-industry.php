...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const pageSlug = 'education-industry'; // IMPORTANT: Set the slug for the current page
    ...
    function createPageContent(slug) {
        const pageData = {
            "slug": slug,
            "title": "Education Industry Solutions | Web Nexa Technologies",
            "meta_description": "Digital solutions for the education sector, including e-learning platform development, student information systems, and digital marketing for student recruitment.",
            "banner_image_url": "assets/images/header-icon/Industries/Education (2).png",
            "banner_title": "Education Industry",
            "breadcrumb_items": [
            ...
            "sections": [
                {
                    ...
                    "content_json": {
                        "text": "<p>Technology is transforming the way we learn. We partner with educational institutions and EdTech companies to build innovative digital learning experiences. From custom e-learning platforms to digital marketing campaigns for student acquisition, we provide the technical and strategic expertise to help you succeed in the modern education landscape.</p>"
                    }
                },
                {
                    "section_order": 1,
                    ...
                    "content_json": [
                        {"icon": "fa-solid fa-laptop-code", "title": "E-learning & LMS Platforms", "description": "Developing custom Learning Management Systems (LMS) and virtual classrooms with features like video lectures, quizzes, and progress tracking."},
                        {"icon": "fa-solid fa-user-graduate", "title": "Student Information Systems (SIS)", "description": "Building integrated systems to manage student admissions, enrollment, grades, and other administrative data."},
                        {"icon": "fa-solid fa-mobile-screen-button", "title": "Educational Mobile Apps", "description": "Creating engaging and interactive mobile learning apps for students of all ages."},
                        {"icon": "fa-solid fa-bullhorn", "title": "Digital Marketing for Student Recruitment", "description": "Running targeted SEO and paid ad campaigns to attract and enroll prospective students."},
                        {"icon": "fa-solid fa-globe", "title": "University & School Websites", "description": "Designing and developing professional, informative, and easy-to-navigate websites for educational institutions."},
                        {"icon": "fa-solid fa-vr-cardboard", "title": "AR/VR in Education", "description": "Exploring and developing immersive learning experiences using Augmented and Virtual Reality technologies."}
                    ]
                }
            ]
        };
