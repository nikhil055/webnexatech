<?php 
$page_title = 'Self Drive Portal';
 include_once __DIR__ . '/../../config.php'; include_once __DIR__ . '/../../header.php'; ?>
<?php 
include_once __DIR__ . '/../../backend/db.php';
$page_file = 'solutions/car-rental/self-drive-portal.php';
...
$display_banner_title = ($banner_data && !empty($banner_data['banner_title'])) ? $banner_data['banner_title'] : 'Self-Drive Car Rental Portal';
?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8">
                <div class="ser-head text-center" data-aos="fade-up">
                    ...
                    <h3>Ready to Launch Your Self-Drive Rental Portal?</h3>
                    <p class="lead mt-3">Contact us today to discuss your portal needs and get a free consultation. Let's work together to achieve your business goals.</p>
