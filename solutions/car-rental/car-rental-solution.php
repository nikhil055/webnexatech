<?php 
$page_title = 'Car Rental Solution';
 include_once __DIR__ . '/../../config.php'; include_once __DIR__ . '/../../header.php'; ?>
<?php 
include_once __DIR__ . '/../../backend/db.php';
$page_file = 'solutions/car-rental/car-rental-solution.php';
...
$display_banner_title = ($banner_data && !empty($banner_data['banner_title'])) ? $banner_data['banner_title'] : 'Car Rental Solution';
?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8">
                <div class="ser-head text-center" data-aos="fade-up">
                    ...
                    <h3>Ready to Drive Your Car Rental Business Forward?</h3>
                    <p class="lead mt-3">Contact us today to discuss your car rental solution needs and get a free consultation. Let's work together to achieve your business goals.</p>
