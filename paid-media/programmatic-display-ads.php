<?php 
$page_title = 'Programmatic Display | WebNexa';
...
<style>
    ...
    .gradient-prog-text { background: linear-gradient(90deg, #009688, #4db6ac); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
...
<div class="paid-main">
    ...
    <section class="web-hero">
        ...
        <div class="container">
            <div class="tech-badge" data-aos="fade-down">Real-Time Bidding Ecosystem</div>
            <h1 data-aos="zoom-in">Programmatic <br> <span class="gradient-prog-text">Display Engineering</span></h1>
            <p style="color: #94a3b8; max-width: 750px; margin: 0 auto; font-size: 19px; line-height: 1.8;" data-aos="fade-up">High-frequency automated ad buying utilizing AI-powered DSPs to place your brand in front of high-value audiences at the perfect millisecond.</p>
        </div>
    </section>
    ...
    <section class="content-block" style="background: #080b12; border-top: 1px solid rgba(255,255,255,0.05);">
        <div class="container">
            <div class="text-center" data-aos="fade-up">
                ...
                <h2 class="section-title">The DSP <br> <span class="gradient-prog-text">Automation Flow</span></h2>
            </div>
            <div class="flow-timeline">
                <div class="flow-step" data-aos="fade-right">
                    <h5>SSP Integration</h5>
                    <p>Connecting with Supply-Side Platforms to access global premium display and video inventory.</p>
                </div>
                <div class="flow-step" data-aos="fade-right" data-aos-delay="100">
                    <h5>Neural Bid Logic</h5>
                    <p>Deploying AI models to evaluate every impression opportunity in under 10 milliseconds.</p>
                </div>
                <div class="flow-step" data-aos="fade-right" data-aos-delay="200">
                    <h5>Contextual Sync</h5>
                    <p>Filtering placements based on page sentiment and entity analysis for 100% brand safety.</p>
                </div>
                <div class="flow-step" data-aos="fade-right" data-aos-delay="300">
                    <h5>Frequency Capping</h5>
                    <p>Orchestrating cross-channel frequency to maximize reach while minimizing ad fatigue.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="content-block">
        <div class="container">
            <div class="text-center" data-aos="fade-up">
                ...
                <h2 class="section-title">Programmatic Engineering <span class="gradient-prog-text">Matrix</span></h2>
            </div>
            <div class="cap-grid-massive">
                <div class="glass-card" data-aos="fade-up">
                    <div class="cap-icon"><i class="fas fa-robot"></i></div>
                    <h4>RTB & AI <br> Optimization</h4>
                    <p>Real-time bidding across global exchanges using neural networks to predict intent.</p>
                    <ul class="cap-feat-list"><li>AI Bidding</li><li>Auction Logic</li><li>CPM Focus</li></ul>
                </div>
                <div class="glass-card" data-aos="fade-up" data-aos-delay="100">
                    <div class="cap-icon"><i class="fas fa-layer-group"></i></div>
                    <h4>Omni-Channel <br> Ecosystems</h4>
                    <p>Unified display, native, and video buying across premium publishers through a single hub.</p>
                    <ul class="cap-feat-list"><li>Native Flow</li><li>Video RTB</li><li>Banner Logic</li></ul>
                </div>
                <div class="glass-card" data-aos="fade-up" data-aos-delay="200">
                    <div class="cap-icon"><i class="fas fa-fingerprint"></i></div>
                    <h4>Contextual <br> Intelligence</h4>
                    <p>Placing ads based on content and user intent without relying on legacy cookie data.</p>
                    <ul class="cap-feat-list"><li>Cookieless</li><li>Intent Map</li><li>Entity Sync</li></ul>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="content-block" style="background: #080b12;">
        <div class="container">
            <div class="text-center" data-aos="fade-up">
                ...
                <h2 class="section-title">Manual Buying vs <br> <span class="gradient-prog-text">WebNexa Programmatic</span></h2>
            </div>
            <div class="comp-box" data-aos="zoom-in">
                <div class="comp-row comp-header"><span>Features</span><span>Manual Display</span><span style="color:#009688;">WebNexa Elite</span></div>
                <div class="comp-row"><span>Speed</span><span class="comp-val">Daily Adjustments</span><span class="comp-val best"><i class="fas fa-bolt"></i> 10ms Real-Time</span></div>
                <div class="comp-row"><span>Inventory</span><span class="comp-val">Site-by-Site</span><span class="comp-val best"><i class="fas fa-microchip"></i> Global SSP Access</span></div>
                <div class="comp-row"><span>Data Usage</span><span class="comp-val">Static Segments</span><span class="comp-val best"><i class="fas fa-chart-line"></i> Dynamic AI Modeling</span></div>
                <div class="comp-row" style="border:none;"><span>Safety</span><span class="comp-val">Basic Blacklists</span><span class="comp-val best"><i class="fas fa-shield-halved"></i> Real-time Sentiment Scan</span></div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5" style="background: #009688; color:#fff;">
        <div class="container d-flex justify-content-between align-items-center flex-wrap gap-3">
            <h4 style="margin:0; font-weight:900;">24/7 BIDDING SYSTEM MONITORING ACTIVE</h4>
            <div style="font-weight:700; letter-spacing:1px; background:rgba(0,0,0,0.2); padding:10px 25px; border-radius:50px;">STATUS: CPM OPTIMIZED</div>
        </div>
    </section>
